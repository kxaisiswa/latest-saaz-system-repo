            ...
            <form action="UpdateStudentServlet" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        ...
                        <input type="email" class="form-control" name="studemail" placeholder="" value="<c:out value="${studentinfo.studemail}" />" required>
                        <div class="invalid-feedback">
                    ...
                    <div class="col-4">
                        ...
                        <select class="form-select" name="studlivingplace" onchange="displayinput(this)" required>
                    ...
                    <div class="row mt-4" id="homeinput" style="display: none !important;">
	                    <div class="col-6">
	                        ...
	                        <input type="text" class="form-control" name="transportmode" placeholder="" value="<c:out value="${studentinfo.transportmode}" />" required>
	                        <div class="invalid-feedback">
	                    ...
	                    <div class="col-6">
	                        ...
	                        <input type="number" class="form-control" name="studschooldistance" placeholder="" value="<c:out value="${studentinfo.studschooldistance}" />" required>
	                        <div class="invalid-feedback">
